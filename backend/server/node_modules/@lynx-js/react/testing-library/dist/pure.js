...
import * as __WEBPACK_EXTERNAL_MODULE__lynx_js_react_jsx_runtime_3b157905__ from "@lynx-js/react/jsx-runtime";
import * as __WEBPACK_EXTERNAL_MODULE_preact__ from "preact";
import * as __WEBPACK_EXTERNAL_MODULE_preact_hooks_ad43f81f__ from "preact/hooks";
import * as __WEBPACK_EXTERNAL_MODULE_preact_test_utils_c2734169__ from "preact/test-utils";
...
var __webpack_modules__ = {
    "../../../node_modules/.pnpm/@testing-library+dom@10.4.0/node_modules/@testing-library/dom/dist/@testing-library/dom.esm.js": function(module, __webpack_exports__, __webpack_require__) {
        ...
        const queryAllByRole = function(container, role, _temp) {
            ...
            if (void 0 !== expanded) {
                var _allRoles$get10;
                if ((null == (_allRoles$get10 = lib.roles.get(role)) ? void 0 : _allRoles$get10.props['aria-expanded']) === void 0) throw new Error("\"aria-expanded\" is not supported on role \"" + role + "\".");
            }
...
(0, dom_esm.jQ)({
    asyncWrapper: async (cb)=>{
        let result;
        await (0, __WEBPACK_EXTERNAL_MODULE_preact_test_utils_c2734169__.act)(()=>{
            result = cb();
        });
        return result;
    },
...
function render(ui, { queries, wrapper: WrapperComponent, enableMainThread = false, enableBackgroundThread = true } = {}) {
    ...
    const wrapUiIfNeeded = (innerElement)=>WrapperComponent ? (0, __WEBPACK_EXTERNAL_MODULE_preact__.h)(WrapperComponent, null, innerElement) : innerElement;
    ...
    return {
        ...
        ...(0, dom_esm.W2)(lynxEnv.mainThread.elementTree.root, queries)
    };
}
function cleanup() {
    const isMainThread = __MAIN_THREAD__;
    ...
    lynxEnv.mainThread.elementTree.root = void 0;
...
function renderHook(renderCallback, options) {
    ...
    const result = (0, __WEBPACK_EXTERNAL_MODULE_preact__.createRef)();
    function TestComponent({ renderCallbackProps }) {
        const pendingResult = renderCallback(renderCallbackProps);
        (0, __WEBPACK_EXTERNAL_MODULE_preact_hooks_ad43f81f__.useEffect)(()=>{
            result.current = pendingResult;
        });
        return null;
    }
    const { rerender: baseRerender, unmount } = render(/*#__PURE__*/ (0, __WEBPACK_EXTERNAL_MODULE__lynx_js_react_jsx_runtime_3b157905__.jsx)(TestComponent, {
        renderCallbackProps: initialProps
    }), {
        wrapper
    });
    function rerender(rerenderCallbackProps) {
        return baseRerender(/*#__PURE__*/ (0, __WEBPACK_EXTERNAL_MODULE__lynx_js_react_jsx_runtime_3b157905__.jsx)(TestComponent, {
